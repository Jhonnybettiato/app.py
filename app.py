...
st.set_page_config(page_title="Aviator Elite PY v4.1", page_icon="🦅", layout="wide")
...
def deshacer_ultimo():
    if st.session_state.historial:
        ...
        # por ahora reinicia para evitar errores de cálculo manual.
        st.toast("Vuelo eliminado. El saldo se ajustará en la próxima apuesta.")
